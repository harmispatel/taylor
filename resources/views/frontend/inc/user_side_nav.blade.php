        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                ...
                @if(Auth::user()->user_type == 'repair_store')
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('repairStore.paymentHistory') }}" class="aiz-side-nav-link {{ areActiveRoutes(['repairStore.paymentHistory'])}}">
                            <i class="las la-calendar-check aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Payment History') }}</span>
                        </a>
                    </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('user.model_list') }}" class="aiz-side-nav-link {{ areActiveRoutes(['user.model_list','user.album_list','user.album_post_list','user.single_model_gallery'])}}">
                        <i class="las la-atom aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Models List') }}</span>
                    </a>
                </li>
