                                ...
                                <li class="minw-0 col-4 col-md mt-3">
                                    <a href="{{ route('products.category', $category->slug) }}" class="d-block rounded bg-white p-2 text-reset shadow-sm">
                                        <img
                                            ...
                                            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';"
                                        >
                                        <div class="text-truncate fs-12 fw-600 mt-2 opacity-70">{{ translate($category->getTranslation('name')) }}</div>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
            ...
            <div class="content_inner_wrapper row">
                <div class="content_left_col col-lg-3 ">
                    ...
                    <div class="pro_left_wrapper">
                        <div class="d-inline-block d-md-block ">
                            <div class="d-flex mb-3 align-items-baseline border-bottom">
                                <h3 class="h5 fw-700 mb-0">
                                    <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block"> {{translate('Measurments')}}</span>
                                </h3>
                            </div>
                        ...
                        <div class="d-flex mb-3 align-items-baseline border-bottom">
                            <h3 class="h5 fw-700 mb-0">
                                <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block"> {{translate('Latest Products')}}</span>
                            </h3>
                        </div>
                    ...
                    <div class="icon_main_wrapper">
                        <div class="icon_items_wrapper">
                            ...
                            <div class="icon_content">
                                <h3 class="icon_title"> {{translate('free shipping')}}</h3>
                                <p class="icon_desc">{{ translate('Lorem ipsum dolor, sit amet.')}}</p>
                            </div>
                        </div>
                        <div class="icon_items_wrapper">
                            <div class="icon_bg" style="background-image: url({{ static_asset('assets/img/shield.png') }})"></div>
                            <div class="icon_content">
                                <h3 class="icon_title"> {{translate('Lorem ipsum dolor')}}</h3>
                                <p class="icon_desc">{{ translate('Lorem ipsum dolor, sit amet.')}}</p>
                            </div>
                        </div>
                        <div class="icon_items_wrapper">
                            ...
                            <div class="icon_content">
                                <h3 class="icon_title"> {{translate('promotion gifts')}}</h3>
                                <p class="icon_desc">{{ translate('Lorem ipsum dolor, sit amet.')}}</p>
                            </div>
                        </div>
                        <div class="icon_items_wrapper">
                            ...
                            <div class="icon_content">
                                <h3 class="icon_title"> {{translate('money back')}}</h3>
                                <p class="icon_desc">{{ translate('Lorem ipsum dolor, sit amet.')}}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                                ...
                                <div class="d-flex flex-wrap mb-3 align-items-baseline border-bottom">
                                    <h3 class="h5 fw-700 mb-0">
                                        <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">{{  translate('Crazy Sunday') }}</span>
                                    </h3>
                                </div>
                    ...
                    <section class="mb-4">
                        <div class="container">
                            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                                ...
                                <div class="d-flex flex-wrap mb-3 align-items-baseline border-bottom">
                                    <h3 class="h5 fw-700 mb-0">
                                        <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">{{  translate('Personalise Products') }}</span>
                                    </h3>
                                </div>
