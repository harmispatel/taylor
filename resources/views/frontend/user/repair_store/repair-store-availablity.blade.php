...
<div class="aiz-titlebar mt-2 mb-4">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{ translate('Repair Store Availiablity') }}</h1>
        </div>
    </div>
</div>
...
<div class="row gutters-10">
    <div class="col-md-12">
        ...
        <form method="POST" action="{{route('repairStore.availablity.save')}}">
             @csrf
            <div class="card">
                            ...
                            <div class="border-0">
                                <div class="row px-3">
                                    ...
                                    <div class="col-sm-10 list">
                                        ...
                                        @if ($repairStoreAvaliablity->isNotEmpty())

                                            @foreach ($repairStoreAvaliablity as $item)
