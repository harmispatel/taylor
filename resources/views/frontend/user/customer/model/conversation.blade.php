...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="pt-4" action="{{ route('user.measurer.conversations', encrypt($conversation->id)) }}"
            method="POST">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="p-3">
                    <form class="form-default create-appointment-form" role="form"
                        action="{{ route('user.model_appointment_create') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    <input type="datetime-local" name="appointment_datetime" class="datetime form-control"
