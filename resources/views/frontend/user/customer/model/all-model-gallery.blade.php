...
<div class="aiz-titlebar mt-2 mb-4">
    ...
    <form method="POST"  action="{{ route('seller.all_model_gallery') }}"  name="filter_form" id="filterForm">
        ...
        <div class="col-md-3">
                ...
                @endphp
                <select name="user_id" onchange="formsubmit()" class="form-control aiz-selectpicker" data-live-search="true">
            ...
            <div class="col-md-2">
                <select name="target_id" onchange="formsubmit()" class="form-control aiz-selectpicker" data-live-search="true">
            ...
            <div class="col-md-3">
                <select name="product_category" onchange="formsubmit()" class="form-control aiz-selectpicker" data-live-search="true">
            ...
            <div class="col-md-2">
                <select name="size" onchange="formsubmit()" class="form-control aiz-selectpicker" data-live-search="true">
                    <option value="">Body Size</option>
                    <option value="">{{ translate('Select Size') }}</option>
                    @if(@$post['product_category']== 1)
            ...
            <div class="col-md-2">
                ...
                @endphp
                <select name="brand" onchange="formsubmit()" class="form-control aiz-selectpicker" data-live-search="true">
